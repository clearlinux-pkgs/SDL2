...
Source0  : https://www.libsdl.org/release/SDL2-2.30.0.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.30.0.tar.gz.sig
...
%prep
%setup -q -n SDL2-2.30.0
cd %{_builddir}/SDL2-2.30.0
pushd ..
cp -a SDL2-2.30.0 build32
popd
pushd ..
cp -a SDL2-2.30.0 buildavx2
popd
pushd ..
cp -a SDL2-2.30.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706896168
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.3000.0
/V4/usr/lib64/libSDL2-2.0.so.0.3000.0
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.3000.0
