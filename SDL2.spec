...
Source0  : https://www.libsdl.org/release/SDL2-2.26.0.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.26.0.tar.gz.sig
...
%prep
%setup -q -n SDL2-2.26.0
cd %{_builddir}/SDL2-2.26.0
pushd ..
cp -a SDL2-2.26.0 build32
popd
pushd ..
cp -a SDL2-2.26.0 buildavx2
popd
pushd ..
cp -a SDL2-2.26.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669132744
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libSDL2-2.0.so.0.2600.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libSDL2-2.0.so.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libSDL2-2.0.so.0.2600.0
...
/usr/lib32/libSDL2-2.0.so.0.2600.0
