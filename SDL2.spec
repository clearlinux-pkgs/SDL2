...
Source0  : https://www.libsdl.org/release/SDL2-2.30.12.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.30.12.tar.gz.sig
...
License  : BSD-3-Clause CPL-1.0 GPL-3.0 ISC OFL-1.1
...
%setup -q -n SDL2-2.30.12
cd %{_builddir}/SDL2-2.30.12
pushd ..
cp -a SDL2-2.30.12 build32
popd
pushd ..
cp -a SDL2-2.30.12 buildavx2
popd
pushd ..
cp -a SDL2-2.30.12 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738599094
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.3000.12
/V4/usr/lib64/libSDL2-2.0.so.0.3000.12
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.3000.12

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libSDL2-2.0.so.0
/usr/lib32/libSDL2-2.0.so.0.3000.12
