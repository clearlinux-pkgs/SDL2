...
Source0  : https://www.libsdl.org/release/SDL2-2.32.8.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.32.8.tar.gz.sig
...
%setup -q -n SDL2-2.32.8
cd %{_builddir}/SDL2-2.32.8
pushd ..
cp -a SDL2-2.32.8 build32
popd
pushd ..
cp -a SDL2-2.32.8 buildavx2
popd
pushd ..
cp -a SDL2-2.32.8 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748959893
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.3200.8
/V4/usr/lib64/libSDL2-2.0.so.0.3200.8
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.3200.8

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libSDL2-2.0.so.0
/usr/lib32/libSDL2-2.0.so.0.3200.8
