...
Source0  : https://www.libsdl.org/release/SDL2-2.30.5.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.30.5.tar.gz.sig
...
%setup -q -n SDL2-2.30.5
cd %{_builddir}/SDL2-2.30.5
pushd ..
cp -a SDL2-2.30.5 build32
popd
pushd ..
cp -a SDL2-2.30.5 buildavx2
popd
pushd ..
cp -a SDL2-2.30.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720112885
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.3000.5
/V4/usr/lib64/libSDL2-2.0.so.0.3000.5
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.3000.5
