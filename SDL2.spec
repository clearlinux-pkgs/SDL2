...
Source1  : https://www.libsdl.org/release/SDL2-2.28.5.tar.gz.sig
...
%prep
%setup -q -n SDL2-2.28.5
cd %{_builddir}/SDL2-2.28.5
pushd ..
cp -a SDL2-2.28.5 build32
popd
pushd ..
cp -a SDL2-2.28.5 buildavx2
popd
pushd ..
cp -a SDL2-2.28.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698965181
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.2800.5
/V4/usr/lib64/libSDL2-2.0.so.0.2800.5
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.2800.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libSDL2-2.0.so.0
/usr/lib32/libSDL2-2.0.so.0.2800.5
