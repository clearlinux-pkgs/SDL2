...
Source0  : https://www.libsdl.org/release/SDL2-2.30.1.tar.gz
Source1  : https://www.libsdl.org/release/SDL2-2.30.1.tar.gz.sig
...
%prep
%setup -q -n SDL2-2.30.1
cd %{_builddir}/SDL2-2.30.1
pushd ..
cp -a SDL2-2.30.1 build32
popd
pushd ..
cp -a SDL2-2.30.1 buildavx2
popd
pushd ..
cp -a SDL2-2.30.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709743230
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL2-2.0.so.0.3000.1
/V4/usr/lib64/libSDL2-2.0.so.0.3000.1
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.3000.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libSDL2-2.0.so.0
/usr/lib32/libSDL2-2.0.so.0.3000.1
