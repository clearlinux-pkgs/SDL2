...
pushd ..
cp -a SDL2-2.26.4 build32
popd
pushd ..
cp -a SDL2-2.26.4 buildavx2
popd
pushd ..
cp -a SDL2-2.26.4 buildavx512
popd
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libSDL2-2.0.so.0.2600.4
/usr/lib64/glibc-hwcaps/x86-64-v4/libSDL2-2.0.so.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libSDL2-2.0.so.0.2600.4
/usr/lib64/libSDL2-2.0.so.0
/usr/lib64/libSDL2-2.0.so.0.2600.4

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libSDL2-2.0.so.0
/usr/lib32/libSDL2-2.0.so.0.2600.4
